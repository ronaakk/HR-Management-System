...
//			Project pro4 = new Project("Improve Internet Security", "INPROGRESS", "With the recent data hack, the office"
//					+ "security needs to be improved and proper security team needs to be hired for "
//					+ "implementation");
//			
//			
//			
//			// need to set BOTH SIDES of the relationship manually (1)
//
...
//
//			
//			// need to set BOTH SIDES of the relationship manually (2) can use either 1 or 2
//
//			emp1.setaProject(Arrays.asList(pro1, pro3, pro4));
//			emp2.setaProject(Arrays.asList(pro1));
//			emp3.setaProject(Arrays.asList(pro2, pro4));
//			
